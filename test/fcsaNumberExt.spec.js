  ...
  describe('fcsaNumber', function() {
    ...
    describe('on focus', function() {
      return it('removes the commas', function() {
        ...
        return expect(el.value).toBe('1000#00');
      });
    });
    describe('on blur', function() {
      it('adds commas', function() {
        ...
        return expect(el.value).toBe('1_000#00');
      });
      describe('with negative decimal number', function() {
        return it('correctly formats it', function() {
          ...
          angular.element(el).triggerHandler('focus');
          angular.element(el).triggerHandler('blur');
          return expect(el.value).toBe('-1_000#20');
        });
      });
      return describe('when more than 3 decimals', function() {
        return it('does not add commas to the decimals', function() {
          ...
          angular.element(el).triggerHandler('focus');
          angular.element(el).triggerHandler('blur');
          return expect(el.value).toBe('1_234#5678');
        });
      });
    });
    ...
    return describe('options', function() {
      ...
      describe('maxDigits', function() {
        ...
        it('validates positive numbers not above number of digits with decimals', function() {
          var valid;
          valid = isValid({
            options: '{ maxDigits: 2 }',
            val: '99#99'
        ...
        it('validates negative numbers not above number of digits', function() {
          var valid;
          valid = isValid({
            options: '{ maxDigits: 2 }',
            val: '-99'
        ...
        return it('validates negative numbers not above number of digits and decimals', function() {
          var valid;
          valid = isValid({
            options: '{ maxDigits: 2 }',
            val: '-99#99'
      ...
      return describe('append', function() {
        ...
        return it('removes the append value on focus', function() {
          ...
          angular.element(document.body).append(el);
          angular.element(el).triggerHandler('focus');
          return expect(el.value).toBe('100#00');
        });
      });
    });
  });
